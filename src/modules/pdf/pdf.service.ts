  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .text(
          `Total Amount: BDT ${Number(data.amount).toFixed(2)}`,
          {
            align: "right",
          },
        );
      ...
      doc
        ...
        .font("Helvetica")
        .text(
          "This is a computer-generated electricity bill from Gridora.",
          {
            align: "center",
          },
        );
      ...
      doc
        .moveDown(0.5)
        .text(
          "Please pay your bill before the due date.",
          {
            align: "center",
          },
        );
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        ...
        .text(
          `Amount: BDT ${Number(data.amount).toFixed(2)}`,
        );

      if (data.paymentId) {
        doc.text(
          `bKash Payment ID: ${data.paymentId}`,
        );
      }
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .text(
          `Paid Amount: BDT ${Number(data.amount).toFixed(2)}`,
          {
            align: "right",
          },
        );
