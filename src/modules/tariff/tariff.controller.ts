...
const getAllTariffs = catchAsync(
  async (req: Request, res: Response) => {
...
const getSingleTariff = catchAsync(
  async (req: Request, res: Response) => {
    const { id } = req.params;
...
const getActiveTariffs = catchAsync(
  async (req: Request, res: Response) => {
